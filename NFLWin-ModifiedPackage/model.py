...
class WPModel(object):
    ...
    _default_model_filename = "Defaultmodel.pkl"
    ...
    def load_model(cls, filename=None):
        ...
        # return joblib.load(os.path.join(cls.model_directory, filename),mmap_mode='readonly')
        return p.load(open(os.path.join(cls.model_directory, filename), 'rb'),encoding='latin1')
